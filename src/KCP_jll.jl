...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import KCP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("000eeb74-f857-587a-a816-be5685e97e75"))
platforms = [Pkg.Artifacts.unpack_platform(e, "KCP", artifacts_toml) for e in artifacts["KCP"]]
...
if best_platform === nothing
    @debug("Unable to load KCP; unsupported platform $(triplet(platform_key_abi()))")
else
